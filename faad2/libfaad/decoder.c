                              ...
                              unsigned long sample_buffer_size)
{
    ...
    hDecoder->syntax_element_next_slot = 0;
	...
	memcpy(hInfo->syntax_element_id, hDecoder->syntax_element_id,
		slot * sizeof(hDecoder->syntax_element_id[0]));
	memcpy(hInfo->syntax_element_pos, hDecoder->syntax_element_pos,
		slot * sizeof(hDecoder->syntax_element_pos[0]));
	memcpy(hInfo->syntax_element_is_fill_data,
	    hDecoder->syntax_element_is_fill_data,
	    slot * sizeof(hDecoder->syntax_element_is_fill_data[0]));
    }

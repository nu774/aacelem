...
typedef struct
{
    ...
    */
    ...
    uint32_t syntax_element_next_slot;
    uint8_t syntax_element_id[MAX_SYNTAX_ELEMENTS];
    uint32_t syntax_element_pos[MAX_SYNTAX_ELEMENTS];
    uint8_t syntax_element_is_fill_data[MAX_SYNTAX_ELEMENTS];
} NeAACDecStruct;
